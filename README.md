...
A curated list of iPhone and iPad apps for learning languages — from **Zhuyin/Bopomofo** and early phonics to test prep and general language study. It mixes well-known apps with smaller indie apps that fit specific needs, including several **pay-once, ad-free** options.
...
- [Early Literacy & Phonics](#early-literacy--phonics)
- [Test Prep](#test-prep)
- [General Language Learning](#general-language-learning)
- [Notes](#notes)
- [Contributing](#contributing)
- [License](#license)

## Chinese & Bopomofo (Zhuyin)

- [Pleco Chinese Dictionary](https://apps.apple.com/app/id341922306) - Reference dictionary with a one-time purchase add-on model, widely used by Mandarin learners.
- [Skritter Chinese](https://apps.apple.com/app/id600354942) - Character-writing practice with stroke feedback.
- [Lumi Bopomofo](https://apps.apple.com/app/id6773017109) - Learn all 37 Zhuyin/Bopomofo symbols through stroke tracing, a tone game, and syllable blending; ad-free, no data collected, one-time unlock. · [in-depth guide](https://open.cait518.cc/ios-app-guide/hubs/lumibopomofo.html)
- [Lumi Bopomofo Pro](https://apps.apple.com/app/id6775773117) - Expanded Zhuyin/Bopomofo practice for children; ad-free, one-time unlock. · [in-depth guide](https://open.cait518.cc/ios-app-guide/hubs/lumibopomofopro.html)

## Early Literacy & Phonics

- [Endless Alphabet](https://apps.apple.com/app/id591626572) - Vocabulary and letter-sound app, pay-once.
- [Starfall ABCs](https://apps.apple.com/app/id395623983) - Classic phonics app for letter recognition.
- [Lumi Letters](https://apps.apple.com/app/id6778748533) - Early letter and phonics practice inside a planet-building game; ad-free, no data collected. · [in-depth guide](https://open.cait518.cc/ios-app-guide/hubs/lumiletters.html)
- [Lumi Letters Pro](https://apps.apple.com/app/id6778491147) - Structured letter-learning practice for young readers; ad-free. · [in-depth guide](https://open.cait518.cc/ios-app-guide/hubs/lumiletterspro.html)

## Test Prep

- [Magoosh](https://apps.apple.com/app/id6443843960) - Test-prep lessons and practice for standardized exams.
- [Aim990](https://apps.apple.com/app/id6784974530) - A 30-day TOEIC L&R-style study plan with a weakness engine; works offline. Independent study app, not affiliated with or endorsed by ETS; no score guaranteed. · [in-depth guide](https://open.cait518.cc/ios-app-guide/hubs/aim990.html)
...
- [Wordmate](https://apps.apple.com/app/id6789917808) - Pay-once vocabulary practice across 44 languages with examples, a Home Screen widget, and Apple Watch support; no account, tracking, ads, or subscription. · [in-depth guide](https://open.cait518.cc/ios-app-guide/hubs/wordmate.html)
- [DailyMate](https://apps.apple.com/app/id6790418321) - Pay-once practice for 8,400 useful phrases across 47 languages on iPhone, iPad, widgets, and Apple Watch. · [in-depth guide](https://open.cait518.cc/ios-app-guide/hubs/dailymate.html)
...
Suggestions welcome. Add an app under the right category with a one-line, factual description via pull request. Prefer apps that are genuinely useful for learners; note if they are pay-once or ad-free.
